...
#' @param p The power p of \eqn{l_p^p}, i.e., ||x||_p^p = (x_1^p+...x_n^p). Default is 2.
...
#'
#' Output: 0.2588 # should be larger than 0.05
#'
...
#'
#' Output: 0.5282631 # should be larger than 0.05
