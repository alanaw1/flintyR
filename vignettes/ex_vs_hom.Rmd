...
We see that at $\alpha=0.05$ we would consider Example 1's array exchangeable, but not Example 2's array. This demonstrates that feature dependencies can manifest as sample non-exchangeability, so that sample exchangeability is contingent on accounting for feature dependencies.    
