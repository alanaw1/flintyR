...
<details>
  <summary><b>Not enough details for you?</b></summary>
    Good. Regarding Steps 1 and 2 (recoding by pooling), you may download the code book [here](https://michael.muthukrishna.com/cultural-distance-data/). The authors have also developed a [Cultural Distance Web App](http://culturaldistance.com/) that you can use to explore cultural distances if you are interested.
</details>
...
## Generate a dendrogram + heat map to visualize correlations
...
```{r wvs_9, echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r wvs_12, echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE}
